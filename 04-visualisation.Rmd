---
title: 'Session 4: Data visualisation'
knit: (function(input_file, encoding) {
  out_dir <- 'docs';
  rmarkdown::render(input_file,
 encoding=encoding,
 output_file=file.path(dirname(input_file), out_dir, '04-visualisation.html'))})
---
...
Below is an example using the dataset we have built in Session 3.
